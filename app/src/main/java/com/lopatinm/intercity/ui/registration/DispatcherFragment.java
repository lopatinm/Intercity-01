...
public class DispatcherFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_dispatcher, container, false);

        Button register = (Button) root.findViewById(R.id.button0);
        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText name   = (EditText) root.findViewById(R.id.editTextTextPersonName50);
                EditText phone   = (EditText) root.findViewById(R.id.editTextPhone0);
                JSONObject data = new JSONObject();

                try {
                    data.put("name", name.getText().toString());
                    data.put("phone", phone.getText().toString());
                    data.put("role", "moderator");
